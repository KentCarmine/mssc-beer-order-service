...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected guru.sfg.beer.order.service.domain.OrderStatusEnum orderStatusEnumToOrderStatusEnum1(OrderStatusEnum orderStatusEnum) {
        ...
        switch (orderStatusEnum) {
            case NEW:
                orderStatusEnum1 = guru.sfg.beer.order.service.domain.OrderStatusEnum.NEW;
                break;
            case READY:
                orderStatusEnum1 = guru.sfg.beer.order.service.domain.OrderStatusEnum.READY;
                break;
            case PICKED_UP:
                orderStatusEnum1 = guru.sfg.beer.order.service.domain.OrderStatusEnum.PICKED_UP;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + orderStatusEnum);
        }
